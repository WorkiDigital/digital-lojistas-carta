                ...
                <div className="grid md:grid-cols-2 gap-6 mt-8">
                  <div className="bg-brand-black p-4 rounded-lg border border-brand-yellow">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-brand-white">✅ Paulo</h3>
                        <p className="text-gray-400 text-sm">Loja de Móveis</p>
                      </div>
                    </div>
                  ...
                  <div className="bg-brand-black p-4 rounded-lg border border-brand-yellow">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-brand-white">✅ Telma</h3>
                        <p className="text-gray-400 text-sm">Loja de Móveis</p>
                      </div>
                    </div>
                    <div className="space-y-1">
              ...
              <div className="text-center space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6 mt-8">
                  <div className="bg-red-900/20 border border-red-500/30 p-6 rounded-lg">
                    <h3 className="text-lg font-bold text-red-300 mb-3">Opção 1:</h3>
                  ...
                  <div className="bg-green-900/20 border border-green-500/30 p-6 rounded-lg">
                    <h3 className="text-lg font-bold text-green-300 mb-3">Opção 2:</h3>
                    <p className="text-gray-300 text-sm">
                ...
                <div className="bg-brand-yellow/10 border border-brand-yellow/30 p-4 rounded-lg mt-6">
